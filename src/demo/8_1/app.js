...
// // 平行光
// const lightDirection = new Vec3(1.0, 2.0, 1.0).unit()
...
// gl.uniform4f(uLightColor, 1.0, 0.0, 0.0, 1.0)
...
// 矩阵
const nModelMat = gl.getUniformLocation(shaderProgram, "uModelMat")
...
function draw() {
    ...
    gl.uniformMatrix4fv(nModelMat, false, modelMat.getArray())
